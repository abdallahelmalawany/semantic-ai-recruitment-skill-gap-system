    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Computing, software, gadgets", "laptop-outline", "Technology" },
                    { 2, "Research, discoveries, nature", "flask-outline", "Science" },
                    { 3, "Visual arts, design, photography", "color-palette-outline", "Art" },
                    { 4, "All genres, instruments, concerts", "musical-notes-outline", "Music" },
                    { 5, "Athletics, teams, fitness", "football-outline", "Sports" },
                    { 6, "Destinations, adventures, tourism", "airplane-outline", "Travel" },
                    { 7, "Cooking, recipes, restaurants", "restaurant-outline", "Food" },
                    { 8, "Clothing, style, trends", "shirt-outline", "Fashion" },
                    { 9, "Video games, board games", "game-controller-outline", "Gaming" },
                    { 10, "Literature, authors, reading", "book-outline", "Books" },
                    { 11, "Films, cinema, directors", "film-outline", "Movies" },
                    { 12, "Wellness, fitness, medicine", "fitness-outline", "Health" },
                    { 13, "Entrepreneurship, startups", "briefcase-outline", "Business" },
                    { 14, "Learning, teaching, academia", "school-outline", "Education" },
                    { 15, "Government, policy, activism", "podium-outline", "Politics" }
                });
